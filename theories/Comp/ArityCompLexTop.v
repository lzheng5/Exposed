...
Section Adequacy.
  ...
  Lemma Top_n_adequacy n m p e1 e2:
    Top_n n m p e1 e2 ->
    forall ρ1 ρ2,
  ...
  Proof.
    ...
    edestruct (C.Top_n_adequacy _ _ _ _ HC0) with (ρ2 := ρ1') as [j1' [r1' [Hstep1' HRn0]]]; eauto.
    ...
    - edestruct (C0.Top_n_adequacy _ _ _ HC1) with (ρ2 := ρ2) as [j2 [r2 [Hstep2 HRn1]]]; eauto.
