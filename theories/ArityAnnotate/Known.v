...
(* 1. We assign non-exposed webs aribitrarily (say some negative integer) as long as they satisfy the web constraints. *)
(* 2. We assign exposed webs based on the arities. *)
...
Module VKnownM <: VAnn.
  ...
  Definition V_ann
    ...
    Proof.
      ...
      - fcrush.
      - destruct H as [Heqw [Hex [Heqc HVs]]]; subst.
        repeat (split; eauto).
    ...
    Proof.
      ...
      - destruct H0 as [Hlen [Heqv [HWv HV]]]; subst.
        ...
        eapply HV; eauto; lia.
      - destruct H0 as [Heqw [Hex [Heqc HVs]]]; subst.
        repeat (split; eauto).
        rewrite normalize_step in *; try lia.
...
Section Compat.
  ...
  Proof.
    ...
    assert (Hnexw : ~ Ensembles.In web Exposed w) by (eapply HK; eauto).
    assert (Hnexwb : exposedb w = false) by (destruct (exposed_reflect w); try contradiction; auto).
    induction i; simpl; intros; auto;
      repeat (split; auto);
      rewrite Hnexwb; intros; (repeat split; auto).
      intros.
  ...
  Proof.
    ...
    - inv H5.
      ...
      destruct HV as [Hex [Heqw [Hlen HV]]]; subst.
  ...
  Proof.
    ...
    specialize (app_unknown_compat Γ xs f HKf HKxs Hexw H H0); intros Ha.
