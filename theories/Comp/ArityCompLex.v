...
Section Linking.
  ...
  Lemma Top_n_preserves_linking f x n n' m m' e1 e2 e1' e2' :
    Top_n n m e1 e2 ->
    Top_n n' m' e1' e2' ->
    Top_n (n + n') (m + m') (A0.link f x e1 e1') (A1.link f w_link x e2 e2').
  Proof.
    unfold Top_n, Cross.
    intros.
    ...
    eapply (AC.preserves_linking f x e4 e3 e4' e3') in HA1; eauto.
    eapply (C1.Top_n_preserves_linking f _ x m m') in HC1; eauto.
